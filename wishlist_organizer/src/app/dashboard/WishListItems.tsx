      ...
      {items.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 sm:mx-0 mb-[100px] font-raleway">
          {items.map((item) => (
            <div
              key={item.id}
              className="p-4 rounded-md bg-primary_text h-36 overflow-y-auto relative"
            >
              <div className="space-y-2">
                {editingId === item.id ? (
                  <div className="flex flex-col gap-2 relative pb-[25px]">
                    <h1 className="flex text-orange-500 underline">
                      Editing Item
                    </h1>
                    ...
                    <input
                      ...
                      className="w-full p-1 rounded bg-bone text-black"
                    />
                  ...
                  <>
                    ...
                    <h3 className="font-normal text-white min-h-14">
                      {item.item_name} from {item.store}
                    </h3>
